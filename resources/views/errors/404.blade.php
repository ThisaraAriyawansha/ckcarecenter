            ...
            <div class="col-lg-8 col-md-10">
                <div class="error-content text-center" style="background: white; padding: 60px 40px; border-radius: 20px; box-shadow: 0 20px 60px rgba(0,0,0,0.1);">
                    <div class="error-image mb-4">
                        <h1 style="font-size: 150px; font-weight: 700; color: #1C3F6E; margin: 0; line-height: 1;">404</h1>
                    </div>
                    ...
                    <div class="helpful-links mt-5 pt-4" style="border-top: 1px solid #eee;">
                        ...
                        <div class="link-list">
                            <a href="{{ route('services') }}" style="color: #1C3F6E; text-decoration: none; margin: 0 15px; font-size: 14px;">Services</a>
                            <a href="{{ route('about') }}" style="color: #1C3F6E; text-decoration: none; margin: 0 15px; font-size: 14px;">About Us</a>
                            <a href="{{ route('blog') }}" style="color: #1C3F6E; text-decoration: none; margin: 0 15px; font-size: 14px;">Blog</a>
                            <a href="{{ route('contact') }}" style="color: #1C3F6E; text-decoration: none; margin: 0 15px; font-size: 14px;">Contact</a>
                        </div>
                    </div>
                </div>
            </div>
