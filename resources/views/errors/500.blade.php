            ...
            <div class="col-lg-8 col-md-10 col-12">
                <div class="error-content text-center">
                    <div class="error-image">
                        <h1 class="error-number" style="color: #dc3545;">500</h1>
                    </div>
                    ...
                    <div class="error-actions">
                        ...
                        <a href="javascript:location.reload()" class="btn-error btn-error-outline">
                            <i class="fas fa-sync-alt"></i> Try Again
                        </a>
                    </div>

                    <div class="helpful-info">
                        <p class="helpful-label">If the problem persists, please contact us:</p>
                        <a href="{{ route('contact') }}" class="helpful-link">Contact Support</a>
                    </div>
                </div>
            </div>
        </div>
